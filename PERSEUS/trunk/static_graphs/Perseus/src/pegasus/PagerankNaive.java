...
//			output.collect( key, new Text( Double.toString(next_rank) ) );
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////
    // STAGE 2b: removing the prefix "v" from the pagerank scores
	//  - Input: nodeID \t v<pagerank score>
	//  - Output: nodeID \t <pagerank score>
    ////////////////////////////////////////////////////////////////////////////////////////////////
	...
	protected Path minmax_path = null; //new Path("pr_minmax");
	protected Path distr_path = null; //new Path("pr_distr");
    ...
    {
		System.out.println("PagerankNaive <edge_path> <temppr_path> <output_path> <# of nodes>  <# of tasks> <max iteration> <makesym or nosym> <new or contNN> <vector_path> <minmax_path> <distr_path>");
...
//		vector_path = new Path("pr_vector");
		...
		vector_path = new Path(args[8]); //new Path("prblk_vector");
		...
		// remove prefix "v" from pagerank scores
		System.out.println("Just changing the format of the output (so that the pagerank does not come after the letter v)...");
		JobClient.runJob(configStage2b());
...
//		FileSystem fs = FileSystem.get( getConf() );
		fs.copyToLocalFile(vector_path, new Path(vector_path+"_local"));
