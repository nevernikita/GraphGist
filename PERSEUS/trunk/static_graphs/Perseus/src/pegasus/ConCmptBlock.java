...
//		System.exit(result);
    ...
    public int run (final String[] args) throws Exception
    {
		...
		curbm_unfold_path = new Path("concmpt_block_curbm");
		summaryout_path = new Path("concmpt_block_summaryout");
		...
		fs.copyToLocalFile(curbm_unfold_path, new Path(curbm_unfold_path+"_local"));
		fs.copyToLocalFile(summaryout_path, new Path(summaryout_path+"_local"));

		// finishing.
		System.out.println("\n[PEGASUS] Connected component computed.");
		System.out.println("[PEGASUS] Total Iteration = " + iter_counter);
		System.out.println("[PEGASUS] Connected component information is saved in the HDFS concmpt_block_curbm as\n\"node_id	'msf'component_id\" format");
		System.out.println("[PEGASUS] Connected component distribution is saved in the HDFS concmpt_block_summaryout as\n\"component_id	number_of_nodes\" format.\n");
