...
public class RWRBlock extends Configured implements Tool 
{
	...
	protected Path query_path = new Path("rwrblk_query_norm");
	protected Path query_block_path = new Path("rwrblk_query_norm_block");
	protected Path diff_path = new Path("rwrblk_vector_difference");
    protected Path vector_unfold_path = null; //new Path("rwrblk_vector");
	protected Path minmax_path = null; //new Path("rwrblk_minmax");
	protected Path distr_path = null; //new Path("rwrblk_distr");
...
//		System.exit(result);
    ...
    public int run (final String[] args) throws Exception
    {
		...
		System.out.println("Checking the vector path: " + vector_path);
		tempmv_path = new Path("rwr_tempmv_block");
		mv_output_path = new Path("rwr_output_block");
		new_vector_path = new Path("rwrblk_vector_new");
		...
		vector_unfold_path = new Path(args[8]); //new Path("rwrblk_vector");
		minmax_path = new Path(args[9]); //new Path("rwrblk_minmax");
		distr_path = new Path(args[10]); //new Path("rwrblk_distr");
				
		local_output_path = "rwrblk_output_temp";
		...
		new_args[0] = "rwrblk_query_norm";
		new_args[1] = "rwrblk_query_norm_block";
